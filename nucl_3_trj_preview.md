### N<sub>3</sub><sup>run_1</sup> -Nucleosome with modifications H4K5ac, H3K9ac, H3K27ac, H3K56ac + H3K18ac, H4K91ac, H2BK5ac, H4K8ac (PDB ID 1KX5)
...
<script>
  var pdb="trj/3_nucl.pdb"
  var xtc="trj/3_nucl_10ns_filtered_1run.xtc"
  var csvfile="dat/3_nucl_1run_unwrap.csv" 
  var trjstep = 10;
