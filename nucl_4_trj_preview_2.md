### N<sub>4</sub><sup>run_2</sup> -Nucleosome with modifications H3K18ac, H3K4ac, H4K91ac, H4K8ac, H2AK5ac, H2BK5ac, H2BK12ac, H2BK20ac, H2BK15ac, H2BK120ac (PDB ID 1KX5)
...
<script>
  var pdb="trj/4_nucl.pdb"
  var xtc="trj/4_nucl_10ns_filtered_2run.xtc"
  var csvfile="dat/4_nucl_1run_unwrap.csv" 
  var trjstep = 10;
  $(document).ready(function() {
    ...
    $('input[type=checkbox][name=ALY_check]').on('change', toggle_ALY_visibility);
    ...
    function toggle_ALY_visibility() {
      var state = $(this).is(":checked");
      window.acetylated_AA_selection.setVisibility(state);
    }
    ...
    <input class="form-check-input " type="checkbox" name="ALY_check" value="" id="ALY_check">
    <label class="form-check-label " for="ALY_check">
      Show ALY
    </label>
