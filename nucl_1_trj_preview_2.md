### N<sub>1</sub><sup>run_2</sup> -Nucleosome with modifications H3K14ac and H3K23ac (PDB ID 1KX5)
...
<script>
  var pdb="trj/1_nucl.pdb"
  var xtc="trj/1_nucl_10ns_filtered_2run.xtc"
  var csvfile="dat/1_nucl_1run_unwrap.csv" 
  var trjstep = 10;
